            ...
            >
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-8 md:grid-cols-2" noValidate>
                    ...
                    <div className="relative group">
                        <input
                            ...
                            autoComplete="off"
                        />
                        <label htmlFor="title" className="absolute left-0 top-3 text-gray-500 text-sm cursor-text transition-all peer-placeholder-shown:top-3 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-focus:top-[-0.75rem] peer-focus:text-xs peer-focus:text-indigo-400 select-none">
                            Title
                        </label>
                    </div>
              ...
              `}
                    ...
                    <div className="relative group">
                        ...
                        />
                        <label htmlFor="date" className="absolute left-0 top-3 text-gray-500 text-sm cursor-text transition-all peer-focus:top-[-0.75rem] peer-focus:text-xs peer-focus:text-indigo-400 select-none">
                            Date
                        </label>
                    </div>
                    ...
                    <div className="relative group md:col-span-2">
                        <input
                            ...
                            autoComplete="off"
                        />
                        <label htmlFor="venue" className="absolute left-0 top-3 text-gray-500 text-sm cursor-text transition-all peer-placeholder-shown:top-3 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-focus:top-[-0.75rem] peer-focus:text-xs peer-focus:text-indigo-400 select-none">
                            Venue
                        </label>
                    </div>
                    ...
                    <div className="relative group md:col-span-2">
                        ...
                        />
                        <label htmlFor="description" className="absolute left-0 top-3 text-gray-500 text-sm cursor-text transition-all peer-placeholder-shown:top-3 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-focus:top-[-0.75rem] peer-focus:text-xs peer-focus:text-indigo-400 select-none">
                            Description
                        </label>
                    </div>
                    ...
                    <div className="md:col-span-2">
                        ...
                        <div className="flex flex-wrap gap-3 mt-4">
                            {formData.tags.map(tag => (
                                <span key={tag} className="flex items-center gap-2 bg-indigo-800 border border-indigo-700 text-indigo-300 px-4 py-1 rounded-full text-sm font-medium select-none shadow-sm">
                                    {tag}
                                    <button type="button" onClick={() => handleRemoveTag(tag)} className="text-red-400 hover:text-red-600 font-extrabold" aria-label={`Remove tag ${tag}`}>
                                        ×
                                    </button>
                                </span>
                            ))}
                    ...
                    <div className="md:col-span-2">
                        ...
                        {formData.imageUrl && (
                            <div className="relative mt-6 w-full h-56 rounded-lg overflow-hidden border border-indigo-700 shadow-md">
                                <Image src={formData.imageUrl} alt="Event Preview" fill sizes="(max-width: 768px) 100vw, 600px" style={{ objectFit: 'cover' }} priority={false} />
                            </div>
                        )}
                    </div>
